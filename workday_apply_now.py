...
def handle_intervention(page, kind: str, company: str, job_title: str) -> bool:
    ...
    if kind == "otp":
        ...
        print(f"          👉 Please CHECK GMAIL (your.email@example.com),")
...
def workday_create_account(page, email: str, password: str, company_key: str) -> bool:
    ...
    try:
        ...
        if any(p in body for p in SUCCESS_PHRASES):
            ...
            print(f"          📧 Check Gmail (your.email@example.com) for verification email")
        ...
        if signed_in:
            ...
            if created == "exists":
                ...
                if signed_in:
                    ...
                    print(f"             3. Enter your.email@example.com")
...
def step_contact_information(page):
    ...
    _fill(page, WD["address_line1"], "123 Main St")
    time.sleep(0.2)
    ...
    time.sleep(0.3)
    _fill(page, WD["phone_number"], "5555555555")
    time.sleep(0.3)
...
def step_my_experience(page, resume_path: str):
    ...
    if _exists(page, WD["linkedin_url"], timeout=3000):
        _fill(page, WD["linkedin_url"], "https://www.linkedin.com/in/yourusername")
        time.sleep(0.3)
    ...
    while step < max_steps and not submitted:
        ...
        if still_on_auth:
            ...
            if auth_retries > max_auth_retries:
                ...
                print(f"             → enter your.email@example.com → reset to Raghava@2025!")
